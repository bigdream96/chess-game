...
class RookTest {
    ...
    @DisplayName("기본이동")
    void move_rook() {
        Piece pawn = chessBoard.searchPiece(Position.of(6, 7));
        ...
        assertEquals(rook, chessBoard.searchPiece(Position.of(5, 0)));
    }
    ...
    void out_of_board_range() {
        ...
        assertEquals(rook, chessBoard.searchPiece(Position.of(7, 7)));
    }
