...
class KnightTest {
    ...
    void move_knight() {
        ...
        knight.move(chessBoard, Position.of(5,5), Position.of(4,3));
        knight.move(chessBoard, Position.of(4,3), Position.of(2,2));
        knight.move(chessBoard, Position.of(2,2), Position.of(4,1));
        knight.move(chessBoard, Position.of(4,1), Position.of(5,3));
    ...
    void invalid_move_knight() {
        ...
        // 보드판 범위를 벗어난 경우
        knight.move(chessBoard, Position.of(7, 6), Position.of(9, 7));

        // 같은 위치로 이동한 경우
        knight.move(chessBoard, Position.of(7, 6), Position.of(7, 6));

        // 동일 플레이어의 기물을 공격한 경우
        knight.move(chessBoard, Position.of(7, 6), Position.of(9, 7));

        // 행마법에 어긋난경우
        knight.move(chessBoard, Position.of(7, 6), Position.of(4, 5));
