...
class KingTest {
    ...
    void move_king() {
        ...
        Piece king = chessBoard.searchPiece(Position.of(7, 4));

        pawn.move(chessBoard, WHITE, Position.of(6, 4), Position.of(4, 4));
        king.move(chessBoard, WHITE, Position.of(7, 4), Position.of(6, 4));

        assertEquals(king, chessBoard.searchPiece(Position.of(6, 4)));
        assertEquals(pawn, chessBoard.searchPiece(Position.of(4, 4)));
    }

    @Test
    @DisplayName("화이트킹_오른쪽_캐슬링")
    void white_king_right_castling() {
        Piece pawn1 = chessBoard.searchPiece(Position.of(6, 5));
        Piece pawn2 = chessBoard.searchPiece(Position.of(6, 6));
        Piece bishop = chessBoard.searchPiece(Position.of(7, 5));
        Piece knight = chessBoard.searchPiece(Position.of(7, 6));
        Piece king = chessBoard.searchPiece(Position.of(7, 4));
        Piece rook = chessBoard.searchPiece(Position.of(7, 7));
        ...
        assertEquals(king, chessBoard.searchPiece(Position.of(7, 6)));
        assertEquals(rook, chessBoard.searchPiece(Position.of(7, 5)));
    }

    @Test
    @DisplayName("화이트킹_왼쪽_캐슬링")
    void white_king_left_castling() {
        Piece pawn1 = chessBoard.searchPiece(Position.of(6, 1));
        Piece pawn2 = chessBoard.searchPiece(Position.of(6, 2));
        Piece pawn3 = chessBoard.searchPiece(Position.of(6, 3));
        Piece knight = chessBoard.searchPiece(Position.of(7, 1));
        Piece bishop = chessBoard.searchPiece(Position.of(7, 2));
        Queen queen = (Queen)chessBoard.searchPiece(Position.of(7, 3));
        Piece king = chessBoard.searchPiece(Position.of(7, 4));
        Piece rook = chessBoard.searchPiece(Position.of(7, 0));
        ...
        assertEquals(king, chessBoard.searchPiece(Position.of(7, 2)));
        assertEquals(rook, chessBoard.searchPiece(Position.of(7, 3)));
    }
    ...
    void black_king_left_castling() {
        ...
        Piece pawn2 = chessBoard.searchPiece(Position.of(1, 2));
        Piece pawn3 = chessBoard.searchPiece(Position.of(1, 3));
        Piece knight = chessBoard.searchPiece(Position.of(0, 1));
        Piece bishop = chessBoard.searchPiece(Position.of(0, 2));
        Queen queen = (Queen)chessBoard.searchPiece(Position.of(0, 3));
        Piece king = chessBoard.searchPiece(Position.of(0, 4));
        Piece rook = chessBoard.searchPiece(Position.of(0, 0));
        ...
        assertEquals(king, chessBoard.searchPiece(Position.of(0, 2)));
        assertEquals(rook, chessBoard.searchPiece(Position.of(0, 3)));
    }

    @Test
    @DisplayName("블랙킹_오른쪽_캐슬링")
    void black_king_right_castling() {
        Piece pawn1 = chessBoard.searchPiece(Position.of(1, 5));
        Piece pawn2 = chessBoard.searchPiece(Position.of(1, 6));
        Piece bishop = chessBoard.searchPiece(Position.of(0, 5));
        Piece knight = chessBoard.searchPiece(Position.of(0, 6));
        Piece king = chessBoard.searchPiece(Position.of(0, 4));
        Piece rook = chessBoard.searchPiece(Position.of(0, 7));
        ...
        assertEquals(king, chessBoard.searchPiece(Position.of(0, 6)));
        assertEquals(rook, chessBoard.searchPiece(Position.of(0, 5)));
    }
    ...
    void out_of_board_range() {
        ...
        assertEquals(king, chessBoard.searchPiece(Position.of(7,4)));
    }
